				...
				<div class="table-responsive">
						...
						<tbody>
							<c:forEach var="item" items="${ dichvu }">
								<tr>
									...
									<td><a href="suaDichVu/${item.maDichVu}">Edit</a> <a
										href="xoaDichVu/${item.maDichVu}">Delete</a></td>
					...
					<div class="dropdown">
						...
						<div class="dropdown-content">
								<a href="them-dich-vu/1"> Dịch vụ có lương theo giờ </a>
								</br>
								<a href="them-dich-vu/2"> Dịch vụ có lương theo ngày </a>
								</br>
								<a href="them-dich-vu/3"> Dịch vụ có lương theo tháng </a>
								</br>
						</div>
					</div>
				</div>
